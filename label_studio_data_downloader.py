...
def export_and_download_snapshot(output_path: str):
    ...
    logger.info(
        f"Created export snapshot: id={export_id}, status={export_job.status}")
...
def convert_snapshot(output_path: str, export_type: str, export_id: str = None):
...
def download_data(output_path: str = "./data/"):
    ...
    if export_type and export_type != "JSON":
        ...
        convert_snapshot(output_path, export_type, export_id)
